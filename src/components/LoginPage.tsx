        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="text-center mb-6">
              <div className="inline-block bg-gradient-to-r from-[#E85D04] to-[#F99D27] rounded-xl px-5 py-3 mb-4">
                <span className="text-white font-black text-lg tracking-tight" style={{ fontStyle: 'italic' }}>i</span>
                <span className="text-white font-black text-lg">CICI</span>
                <span className="text-white font-black text-lg ml-1">Lombard</span>
              </div>
